...
<xsl:transform version="3.0" 
	...
	<xsl:include href="../../xsl/svg-utility.xsl"/>
	...
	<xsl:variable name="FONT_SIZE_DEFAULT"						as="xs:integer"	select="12"/>	<!-- pt -->
	<xsl:variable name="TEXT_MARGIN_X"							as="xs:double"	select="1.5"/>
	<xsl:variable name="TEXT_MARGIN_Y"							as="xs:double"	select="0"/>
