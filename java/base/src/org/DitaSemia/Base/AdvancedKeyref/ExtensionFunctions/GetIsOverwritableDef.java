...
public class GetIsOverwritableDef extends ExtensionFunctionDefinition {
	
	public static final String LOCAL_NAME	= "getIsOverwritable";
	...
	public ExtensionFunctionCall makeCallExpression() {
		return new GetIsOverwritableCall();
	}
