...
<xsl:stylesheet exclude-result-prefixes="ditaarch opentopic ds" version="2.0"
	...
	<xsl:template match="*[contains(@class, ' topic/dlhead ')] | *[contains(@class, ' topic/dlentry ')]" mode="dl-header-table">
		<tr>
			<xsl:call-template name="commonattributes"/>
	...
	<xsl:template match="*[contains(@class, ' topic/dthd ')] | *[contains(@class, ' topic/ddhd ')]" mode="dl-header-table">
		<th>
			<xsl:call-template name="commonattributes"/>
	...
	<xsl:template match="*[contains(@class, ' topic/dt ')] | *[contains(@class, ' topic/dd ')]" mode="dl-header-table">
		<td>
			<xsl:call-template name="commonattributes"/>
			<xsl:apply-templates mode="#default"/>
		</td>
